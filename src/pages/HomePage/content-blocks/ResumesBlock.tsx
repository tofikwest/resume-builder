...
const ResumesBlock = () => {
  return (
    <div className="homePage-resumeBlock relative bottom-0 right-0 z-10 flex h-[130%]  min-h-[500px] items-center justify-center rounded-[25px] border-[8px] border-solid border-black bg-mobSize p-1 md:absolute md:min-h-0 md:w-1/3 md:bg-cover">
      <Link
