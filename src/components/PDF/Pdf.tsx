...
const Pdf = () => {
  ...
  const handleDownload = async () => {
    const pdfWidth = 210 // Ширина A4 в миллиметрах
    const pdfHeight = 297 // Высота A4 в миллиметрах
    const margin = 0 // Отступы
  ...
  return (
    <div>
      ...
      >
        ...
        <section id="pdf__header" className="pdf__header text-center mb-6">
          <div className="flex justify-center font-bold text-2xl">
            <h2 className="mr-2 pb-2">Tim Stewart</h2>
            <p>Accountant</p>
          </div>
          <address>
      ...
      <button className="absolute right-1 bottom-0" onClick={handleDownload}>
        Download PDF
      </button>
    </div>
  )
