...
const SideBar: React.FC<IProps> = (props: IProps) => {
  ...
  return (
    <>
      <div
        id="sideBar"
        className={`fixed z-[1] float-left inline-block  h-screen  w-[95px] select-none rounded-xl bg-white pt-[90px] shadow-xl xl:w-[75px] xl:px-1 ${
          isOpen && 'open'
        }`}
      >
        <img src={logoPng} />
        <nav className="flex h-[87vh] flex-col text-center uppercase lg:h-[84vh] xl:h-[87vh] ">
          <p className="mb-5 text-[10px] text-gray-600">main menu</p>
          <ul className="mb-16 flex flex-1 select-none flex-col items-center justify-start  gap-2">
            ...
            <li id="builderBtn" className="">
              <Button path={routes_list[1].path}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
