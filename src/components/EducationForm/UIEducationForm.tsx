...
const UIEducationForm: React.FC<IProps> = ({ el, handleDelEducation }) => {
  ...
  return (
    <form
      ...
      className="relative flex h-auto w-full select-none flex-col items-center rounded-xl border border-solid border-additional-color p-4   md:flex-wrap lg:ml-3 "
    >
